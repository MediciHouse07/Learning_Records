...
- rho is the Greek r
- downward, counter clock wise
- phi is between 0 to pi
- phi how far south you are going, like lattitude
- theta longitude
...
- line integral, interpret integral in one variable
- double integral, use two variable integration with the help of curl
...
- length unit sufficiently small
...
- summing tangetial component of F, summming the normal component of F
- velocity field
- passes through the pad over time
- paraledogon
...
- twice rotation rate
- translation effect, rotation effect; it impose it to a trajectory
...
- if F is defined in the entire plane
- or simply connected region
- curl F = Nx-My
- curl F = 0
...
- not to think about how to parameterize it
...
- read it in the way of velocity, read it in the way of parameterizing
...
- vector field
- at every point you have a vector
- fluid
...
- inverse trig
- dwdu, change u a bit how w change
- coefficient
- total differentaial, partial derivative
