...
- want to know the slope of the path
...
- homogeneous is about right hand side
...
- differentiation is with respect of x not with respect of y
...
- stuff it in and divide
- one less constant in the equation
- lumping constants
...
3100<->3600 3600<->4100 4100<->4500 End

2025/07/21

- just discovered a strong reason keep ordinary people ordinary
- unless you call going to complex domain a trick
- zeta
- root of n degree of 1 has n solutions
...
- only function that satisfies the equation
- SHIFT TBR 1000
