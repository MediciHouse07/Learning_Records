...
- commutitivity
- associtivity
- field is generalization of rational number
- real number true ground truth was because of the field properties
- additive inverse
...
- infinite intersection of open set might be a point
